class PricingPlans:
    ...
    class OneTime:
        period = None
        pricing_table = {
            60: 1,    # q=1  => total= round(1*(60.0))= 60
            118: 2,   # q=2  => total= round(2*(58.8889))= 118
            173: 3,   # q=3  => total= round(3*(57.7778))= 173
            227: 4,   # q=4  => total= round(4*(56.6667))= 227
            278: 5,   # q=5  => total= round(5*(55.5556))= 278
            327: 6,   # q=6  => total= round(6*(54.4444))= 327
            373: 7,   # q=7  => total= round(7*(53.3333))= 373
            418: 8,   # q=8  => total= round(8*(52.2222))= 418
            460: 9,   # q=9  => total= round(9*(51.1111))= 460
            500: 10,  # q=10 => total= round(10*(50.0))= 500
        }
